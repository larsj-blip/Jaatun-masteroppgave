...
\input{Sections/abstract} %insert the chapter text from the files

\chapter*{Acknowledgements}
\addcontentsline{toc}{chapter}{\protect\numberline{}Preface} 
\input{Sections/foreword}
\input{Sections/ai-usage}
...
\input{Sections/8_further_work}
\cleardoublepage

\chapter{Sustainability Analysis}
\input{Sections/sustainability_analysis}
\cleardoublepage
